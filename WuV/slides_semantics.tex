...
\begin{frame}\frametitle{Situational vs. Translational Relative Semantics}
\begin{blockitems}{Translational relative semantics}
...
\item uninterpreted symbols in vocabulary given concrete values
