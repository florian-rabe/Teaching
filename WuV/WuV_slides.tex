...
Idea
 ...
 \item generate corresponding
  \begin{itemize}
  \item class definitions for programming languages
  \item table definitions in SQL
  \end{itemize}
 \item use codecs to convert automatically when interchanging data
 \end{itemize}
...
\begin{frame}\frametitle{Codecs in Database Schemas}
\begin{blockitems}{SQL table schema = list of fields where field is}
\item name
\item type \glec{only types of database supported}
\end{blockitems}

\begin{blockitems}{Semantic table schema = list of fields where field is}
\item name
...
schema Instructor
  ...
  courses:  list int codec CommaSeparatedList CourseAsName
schema Course
  name:     string   codec StandardString
