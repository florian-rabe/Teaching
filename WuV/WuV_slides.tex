...
%\begin{frame}\frametitle{Redundancy}
%\begin{blockitems}{Multiple narrative semantics}
%\item Absolute: standard document
%\item Relative: via natural language translations
% \glec{usually English}
%\item Interpreter: absolute as implementation
%\item Compiler: relative via translation to assembly $L$
% \glec{write $\vvddash E\rewrites V$ for $\vdash_L \sem{E}\rewrites \sem{V}$}
%\item Natural language Cross-compilation: relative via translation into other languages
% \glec{Church-Turing thesis: always possible}
%\end{blockitems}
%
%\begin{blockitems}{Equivalence Theorems}
%\item Correctness of compiler: $\vdash E\rewrites V$ iff $\vvdash E\rewrites V$
%\glec{accordingly for other translations}
%\end{blockitems}
%\end{frame}
