...
\[\rul{\vdash c\sqsubseteq d \tb \vdash d\sqsubseteq c}{\vdash c\Equiv e}\]
...
\item<3-> Closed world: yes
 \[\rul{\Gamma[x=i]\vdash f[x=i]\isa c \;\text{ for every individual } i}{\Gamma, x:I\vdash f(x)}\]
...
Composition:
\[\rul{\vdash i \,r\,j \tb \vdash j\,s\,k}{\vdash i\,(r;s)\,j}\]
