...
% All italic...?
% And \Sigma and T are differently arranged in the first bullet point
\begin{theorem}
...
% Was "context-free language" introduced?
We assume a context-free language $l$.

\begin{definition}[Context]
A \textbf{context} is a list of
\begin{compactitem}
% Somethings not right. Is it supposed to tell me that?:
% A context is a list of
% - grammar terminologies as productions of the form ...
% - type terminologies as declarations of the form ...
...
% This syntax is new and probably missing ind Definition (Context):
%                  <--------------->     <-------------->
