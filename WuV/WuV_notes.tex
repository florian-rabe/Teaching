...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Concrete Knowledge}\label{sec:wuv:concr}

\chapter{A Basic Database Language}\label{sec:wuv:bdl}
  \input{concrete}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Computational Knowledge}\label{sec:wuv:comp}

\chapter{A Basic Programming Language}\label{sec:wuv:bpl}
  \input{comp}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Deductive Knowledge}\label{sec:wuv:ded}

\chapter{A Basic Logic}\label{sec:wuv:tfol}
  \input{deductive}
