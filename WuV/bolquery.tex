...
natural language & sentences & and, or, some, everty, \ldots\\
\end{tabular}
\end{center}
...
This is the case for most ontology languages.\ednote{MK: that is not true, most ontology
  languages are decidable, but satisfiability is  (at least) exponential.}
