...
However, for CBC, a fixed or predictable initialization vector opens the resulting scheme up to attacks; so a probabilistic algorithm must be used to generate it.
...
More concretely, the $128$-bit block to be mapped is represented as $16$ chunks of $8$ bits.
