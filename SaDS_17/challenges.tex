...
Because most users do not understand the technical issues, they blindly accept terms of service, thus generously granting access rights to applications, and ultimately creating more user data for the free market.
...
The effects are exacerbated by two symptoms:
\begin{compactitem}
