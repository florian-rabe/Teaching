...
\begin{commgrammar}
\gcomment{contexts}\\
\gprod{\Gamma}{(Decl \bnfalt Assume)^*}{}\\
\gcomment{declarations}\\
\gprod{Decl}{\atypedef{a}{A}}{type definition}\\
\galtprod{\aval{x}{A}{t}}{term definition}\\
\gcomment{local assumptions}\\
\gprod{Assume}{a:\type}{type assumption}\\
\galtprod{x:A}{term assumption}\\
\gcomment{types}\\
\gprod{A}{a}{type names}\\
\galtprod{\ablockI{Decl; A}}{local declaration}\\
\gcomment{terms}\\
\gprod{t}{x}{term names}\\
\galtprod{\ablockI{Decl; x}}{local declaration}
\end{commgrammar}
...
\gprod{Decl}{\adata{a[a^*]}{Con^*}}{IDT}\\
\galtprod{\aclassAI{a[a^*]}{(x:A)^*}{}{Field^*}}{ADT}\\
...
\gprod{Con}{c(A^*)}{constructor in IDT declaration}\\
\gprod{Cas}{\acase{c(x^*)}{t}}{case in pattern-match}\\
\gprod{Field}{f:A}{field in ADT declaration}\\
